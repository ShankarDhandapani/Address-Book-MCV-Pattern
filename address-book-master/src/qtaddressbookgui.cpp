...
void QtAddressBookGUI::createWidgets()
{
    ...
    newContactButton->setStyleSheet("padding : 05px;border-radius:5%;background-color: blue;color:black");
    editContactButton->setStyleSheet("padding : 05px;border-radius:5%;background-color: green;color:black");
    deleteContactButton->setStyleSheet("padding : 05px;border-radius:5%;background-color: red;color:black");
